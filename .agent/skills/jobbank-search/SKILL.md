...
context: fork
allowed-tools: Bash(bun run .agent/skills/jobbank-search/cli/src/cli.ts *)
---
...
```bash
bun run .agent/skills/jobbank-search/cli/src/cli.ts search [flags]
```
...
```bash
bun run .agent/skills/jobbank-search/cli/src/cli.ts detail <id> [--format json|plain]
```
...
bun run .agent/skills/jobbank-search/cli/src/cli.ts search \
...
```bash
bun run .agent/skills/jobbank-search/cli/src/cli.ts detail 1234567 --format plain
```
