...
description: >
  ...
  job posting.
context: fork
allowed-tools: Bash(bun run .agent/skills/linkedin-search/cli/src/cli.ts *)
---
...
```bash
bun run .agent/skills/linkedin-search/cli/src/cli.ts search --location "<place>" [flags]
```
...
```bash
bun run .agent/skills/linkedin-search/cli/src/cli.ts detail <id|url> [--format json|plain]
```
...
bun run .agent/skills/linkedin-search/cli/src/cli.ts search -q "data engineer" -l "Bengaluru, Karnataka, India" --jobage 30 --format table

# Product manager roles in Berlin, remote
bun run .agent/skills/linkedin-search/cli/src/cli.ts search -q "product manager" -l "Berlin, Germany" --remote remote --format table

# Any role, fully remote
bun run .agent/skills/linkedin-search/cli/src/cli.ts search -q "paralegal" -l "Remote" --format table

# Full details for a specific job
bun run .agent/skills/linkedin-search/cli/src/cli.ts detail 4426311357 --format plain
```
